...
<form action="/message/send/${currentPage}" style="margin: 1.5em;" class="form-horizontal" method="post">
    <fieldset>
            ...
            <div class="col-md-5">
                <c:choose>
                    <c:when test="${type == 'reply'}">
                        <input id="toUser" readonly name="toUser" type="text" value="${message.userFrom.login}"
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <c:choose>
                    <c:when test="${type == 'reply'}">
                        <input id="title" name="title" type="text" value="${'Re: '}${message.messageTheme}"
                               class="form-control input-md">
                    </c:when>
                    <c:otherwise>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <c:choose>
                    <c:when test="${type == 'reply'}">
            <textarea id="messageText" rows="5" name="messageText"
                      class="form-control input-md">${'Re: >'}${message.messageText}</textarea>
                    </c:when>
                    <c:otherwise>
